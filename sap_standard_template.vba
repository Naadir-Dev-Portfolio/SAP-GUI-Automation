...
Application.DisplayAlerts = False
    ...
    Set session = connection.Children(0)
      ...
      ' Operation Tab
        ...
        ' Save the workbook
        'targetWorkbook.SaveAs Filename:="https://cadentgasltd.sharepoint.com/sites/BusSvc/CustCent/[COMPANY_REPORT_ID]Team/PowerBI/Datasets/[COMPANY_REPORT_ID]/[COMPANY_REPORT_ID]PBDS942_BOA%20SAP%20Jobs/" & outputName, FileFormat:=51
